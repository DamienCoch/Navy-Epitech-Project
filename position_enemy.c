...
** Last update Thu Feb 16 17:44:57 2017 Benoit Bouton
*/
...
char	**placement_boat_2_enemy(char **str2, char **av)
{
  ...
  cnt = 1;
  boat_2_bis.y_start = (2 + read_2_enemy(av));
  boat_2_bis.x_start = (2 + (2 * read_cord_2_enemy(av)));
  boat_2 = read_boat_2_enemy(av);
  boat_2_bis.y_end = (2 + read_2_end_enemy(av));
  boat_2_bis.x_end = (2 + (2 * read_cord_2_end_enemy(av)));
...
char	**placement_boat_3_enemy(char **str2, char **av)
{
  ...
  cnt = 1;
  boat_3_bis.y_start = (2 + read_3_enemy(av));
  boat_3_bis.x_start = (2 + (2 * read_cord_3_enemy(av)));
  boat_3 = read_boat_3_enemy(av);
  boat_3_bis.y_end = (2 + read_3_end_enemy(av));
  boat_3_bis.x_end = (2 + (2 * read_cord_3_end_enemy(av)));
...
char	**placement_boat_4_enemy(char **str2, char **av)
{
  ...
  cnt = 1;
  boat_4_bis.y_start = (2 + read_4_enemy(av));
  boat_4_bis.x_start = (2 + (2 * read_cord_4_enemy(av)));
  boat_4 = read_boat_4_enemy(av);
  boat_4_bis.y_end = (2 + read_4_end_enemy(av));
  boat_4_bis.x_end = (2 + (2 * read_cord_4_end_enemy(av)));
...
char	**placement_boat_5_enemy(char **str2, char **av)
{
  ...
  cnt = 1;
  boat_5_bis.y_start = (2 + read_5_enemy(av));
  boat_5_bis.x_start = (2 + (2 * read_cord_5_enemy(av)));
  boat_5 = read_boat_5_enemy(av);
  boat_5_bis.y_end = (2 + read_5_end_enemy(av));
  boat_5_bis.x_end = (2 + (2 * read_cord_5_end_enemy(av)));
